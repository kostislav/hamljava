...
public class ReflectionMethodCallTest {
    ...
    public void callsMethod() throws Exception {
        ...
        assertThat(reflectionMethodCall.invoke(new TestObject(12, 34), list(2), RubyBlock.EMPTY, new HtmlOutput(), MockTemplateContext.EMPTY), is((Object)"abc2"));
    }
    ...
    public void rethrowsException() throws Exception {
        ...
        reflectionMethodCall.invoke(new TestObject(12, 34), Collections.emptyList(), RubyBlock.EMPTY, new HtmlOutput(), MockTemplateContext.EMPTY);
    }
}
